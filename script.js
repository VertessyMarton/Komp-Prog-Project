function ErettsegiTeszt(){
    ...
    {
        alert("A szóbeli százaléka nem éri el a 12-t");
    }
    else if (szobeli >= 12 && irasbeli <= 12){
        alert("Az írásbeli százaléka nem éri el a 12-t");
    }
    else if (szobeli <= 12 && irasbeli <= 12){
        alert("Sem a szóbeli, sem az írásbeli százaléka nem érte el a 12-t");
    }
}